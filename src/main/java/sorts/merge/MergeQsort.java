...
/**
    ...
    private volatile int[] firstArray;
    private volatile int[] secondArray;

    private volatile int fRange = 0;
    private volatile int sRange = 0;
...
/**
    ...
    public MergeQsort(int[] inputArray){
        iArray = inputArray;
    }
...
/**
    ...
    public void sort(int[] inputArray) {
        ...
        if (inputArray.length != 0) {
            ...
            synchronized (this) {
                System.out.print("MergeQsort.sort Result Array: [ ");
                arrPrint(inputArray);
                System.out.println("]");
            }
    ...
    private static void doMerge(int[] inputArray, int[] firstArray, int[] secondArray, int fRange, int sRange) {
