...
public class MergeReversBubblesort extends AbstractSorter implements Runnable{
...
/**
    ...
    // Default Constructor
    public MergeReversBubblesort(){}

    // Constructor for multithreading
    public MergeReversBubblesort(int[] inputArray){
        iArray = inputArray;
    }
...
//        }
        ...
        System.out.println("MergeReversBubblesort Time " + getTime());
    }
...
/**
    ...
    */
/**
     * Method that divide input array by two parts and sort it by using {@link BubbleSort#reverseSort(int[])}
     *
    ...
    public synchronized void sort(int[] inputArray) {
        ...
        if (inputArray.length != 0) {
            ...
            synchronized (this) {
                System.out.print("MergeReversBubblesort.sort Result Array: [ ");
                arrPrint(inputArray);
                System.out.println("]");
            }
